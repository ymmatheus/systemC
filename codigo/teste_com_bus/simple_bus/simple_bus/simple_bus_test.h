...
SC_MODULE(simple_bus_test)
{
  ...
  simple_multiplier				 *multiply;		// multiply
...
master_nb = new mips("mips", 3, 0x38, 0x58, false, 20);
	...
	multiply = new simple_multiplier("multiply", 0x100, 0x10F, 32);   // multiply
	...
	bus->slave_port(*multiply);			//multiply
